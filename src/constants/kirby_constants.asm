...
; hKirbyFlags3 flags
	const_def 2
	const KIRBY3F_DIVE_BOUNCE_F ; $2
	const KIRBY3F_DIVE_F ; $3
	const KIRBY3F_DUCK_F ; $4
	const KIRBY3F_FACE_LEFT_F ; $5
	const KIRBY3F_UNK6_F ; $6
	const KIRBY3F_SQUISHED_F ; $7

DEF KIRBY3F_DIVE_BOUNCE EQU 1 << KIRBY3F_DIVE_BOUNCE_F ; $04
...
DEF KIRBY3F_SQUISHED    EQU 1 << KIRBY3F_SQUISHED_F ; $80

DEF SQUISH_BITMASK EQU %11

DEF SQUISH_DOWN    EQU %00
DEF SQUISH_UP      EQU %01
DEF SQUISH_FRONT   EQU %10
DEF SQUISH_BACK    EQU %11
