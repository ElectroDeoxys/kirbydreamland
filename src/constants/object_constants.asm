...
DEF OBJFLAG_IN_VIEW EQU 1 << OBJFLAG_IN_VIEW_F

; wObjectStatuses constants
	const_def
	const OBJSTAT_UNK0_F ; 0
	const OBJSTAT_UNK1_F ; 1
	const OBJSTAT_UNK2_F ; 2
	const OBJSTAT_UNK3_F ; 3
	const OBJSTAT_UNK4_F ; 4
	const OBJSTAT_UNK5_F ; 5
	const OBJSTAT_UNK6_F ; 6
	const OBJSTAT_HURT_F ; 7

DEF OBJSTAT_UNK0 EQU 1 << OBJSTAT_UNK0_F ; $01
DEF OBJSTAT_UNK1 EQU 1 << OBJSTAT_UNK1_F ; $02
DEF OBJSTAT_UNK2 EQU 1 << OBJSTAT_UNK2_F ; $04
DEF OBJSTAT_UNK3 EQU 1 << OBJSTAT_UNK3_F ; $08
DEF OBJSTAT_UNK4 EQU 1 << OBJSTAT_UNK4_F ; $10
DEF OBJSTAT_UNK5 EQU 1 << OBJSTAT_UNK5_F ; $20
DEF OBJSTAT_UNK6 EQU 1 << OBJSTAT_UNK6_F ; $40
DEF OBJSTAT_HURT EQU 1 << OBJSTAT_HURT_F ; $80

; intraction flags
	const_def
	const OBJINT_VULNERABLE_F ; 0
	const OBJINT_UNK1_F ; 1
	const OBJINT_UNK2_F ; 2
	const OBJINT_UNK3_F ; 3
	const OBJINT_UNK4_F ; 4

DEF OBJINT_VULNERABLE EQU 1 << OBJINT_VULNERABLE_F ; $01
DEF OBJINT_UNK1 EQU 1 << OBJINT_UNK1_F ; $02
DEF OBJINT_UNK2 EQU 1 << OBJINT_UNK2_F ; $04
DEF OBJINT_UNK3 EQU 1 << OBJINT_UNK3_F ; $08
DEF OBJINT_UNK4 EQU 1 << OBJINT_UNK4_F ; $10

; wObjectFlashBlinkFlags constants
	const_def
	const BLINK_FLAG_F ; $0
	const FLASH_FLAG_F ; $1

DEF BLINK_FLAG EQU 1 << BLINK_FLAG_F
DEF FLASH_FLAG EQU 1 << FLASH_FLAG_F

; duration of each blinking phase
DEF BLINK_DURATION_INVISIBLE EQU 2
DEF BLINK_DURATION_VISIBLE   EQU 3

; duration of each flashing phase
DEF FLASH_DURATION_ALTPAL EQU 4
DEF FLASH_DURATION_REGPAL EQU 6
